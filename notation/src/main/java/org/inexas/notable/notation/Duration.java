...
public class Duration {
	...
	static Duration getByDenominator(final int denominator) {
		return lookupByDenominator.get(denominator);
	}

	static Duration getByMiki(final String miki) {
	 ...
	 */
	static Duration[] getByClicks(final int clicks) {
	...
	final static Duration quarter = new Duration(
			"quarter", "4", 4, 8, null);
	@SuppressWarnings("unused")
